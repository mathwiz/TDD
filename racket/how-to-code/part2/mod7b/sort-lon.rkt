...
;; Alternative implementation that re-uses both function definitions
;; This allows any number of functions to be encapsulated
;; ListOfNumber -> ListOfNumber
;; sort the numbers in lon in increasing order
(check-expect (sort-lon2 empty) empty)
(check-expect (sort-lon2 (list 1)) (list 1))
(check-expect (sort-lon2 (list 1 2 3)) (list 1 2 3))
(check-expect (sort-lon2 (list 2 1 3)) (list 1 2 3))
(check-expect (sort-lon2 (list 3 2 1)) (list 1 2 3))

(define (sort-lon2 lon)

...
(check-expect (contains? "Waterloo" (cons "UBC" (cons "McGill" empty))) false)
...
(check-expect (map2 sqr (list 4 5)) (list 16 25))
...
;; given pred and list produce a list where each element produces true for pred

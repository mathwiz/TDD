...
class Message(object):
    ...
    def build_shift_dict(self, shift):
        ...
        for it in range(26):
            index = (it + shift_amount) % 26
            cypher[uc[it]] = uc[index]
            cypher[lc[it]] = lc[index]
        return cypher
    ...
    def apply_shift(self, shift):
        ...
        '''
        shift_amount = shift % 26
        d = self.build_shift_dict(shift_amount)
        shifted = ''
        for it in self.get_message_text():
            if it in d:
                shifted += d[it]
            else:
                shifted += it
...
def decrypt_story():
    ...
    cryptMessage = CiphertextMessage(story)
    return cryptMessage.decrypt_message()

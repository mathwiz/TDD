...
def getWordScore(word, n):
    ...
    score = 0
    for it in word:
        score += SCRABBLE_LETTER_VALUES[it]
    score *= len(word)
    ...
    while calculateHandlen(currentHand) > 0:
        ...
        if word == ".":
            ...
            if not isValidWord(word, currentHand, wordList):
                ...
                total += points
                print("\"" + word + "\"", "earned", points, "points. Total:", total)
...
def playGame(wordList):
    ...
    while p != "e":
        if p == "n":
            ...
            print("Invalid input.")
        print()
        p = input("Enter n to deal a new hand, r to replay the last hand, or e to end game: ")
        first = False
